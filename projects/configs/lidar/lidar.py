...
custom_imports = dict(
    imports=['projects.mmdet3d_plugin.model'], allow_failed_imports=False)
...
data_root = '/share/raid1/common/nuscenes/v1.0-trainval/'
data_prefix = dict(
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        decoder_layer=dict(
            ...
            #pos_encoding_cfg=dict(input_channel=256, num_pos_feats=128)
        ),
